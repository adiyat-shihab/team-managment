  ...
  return (
    <>
      <div className=" text-white bg-transparent">
        <nav className="relative  px-4 font-deca py-4 flex justify-between items-center ">
          <div className="text-3xl flex items-center gap-4 font-bold leading-none">
            <LazyLoadImage
              src="https://i.ibb.co/TkFJDCq/united.png"
          ...
          <button className="hidden  lg:block py-2 px-6 text-sm text-white font-bold rounded-xl bg-softBlue  transition duration-200">
            Sign up
          </button>
        </nav>
